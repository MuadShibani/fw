            ...
            <div class="footer-col">
                ...
                <div class="footer-partners-row">
                    ...
                    <div class=" partner-logo-eu">
                        <img src="{{ asset('images/eu.jpeg') }}" alt="Funded by the European Union" class="partner-logo-eu-img">
                    </div>
                    <div class=" partner-logo-light">
                        <img src="{{ asset('images/dr.png') }}" alt="DeepRoot Consulting" class="partner-logo-sm">
                    </div>
                    <div class=" partner-logo-light">
                        <img src="{{ asset('images/rowad.jpg') }}" alt="Rowad Foundation" class="partner-logo-sm">
                    </div>
                </div>
            </div>

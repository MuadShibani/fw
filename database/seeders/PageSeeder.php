    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'content_en'  => '<p>The SIL operates to create sustainable social impact.</p>',
                'content_ar'  => '<p>يعمل المختبر على خلق أثر اجتماعي مستدام.</p>',
                'image_url'   => null,
                'custom_fields' => [
                    'external_link' => '',
                    ...
                    'community_body'  => ['en' => 'Workshops and capacity-building for social entrepreneurs.', 'ar' => 'ورش عمل وبناء قدرات لرواد الأعمال الاجتماعيين.'],
            ...
            // ── Info Center & basic pages — only the hero (title + subtitle + image)
            //    is rendered, but having them in the DB lets admins edit them.
            [
                'page_key'    => 'blog',
                'title_en'    => 'Blog',
                'title_ar'    => 'المدونة',
